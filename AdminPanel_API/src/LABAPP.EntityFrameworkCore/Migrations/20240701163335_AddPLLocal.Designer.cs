...
namespace LABAPP.Migrations
{
    ...
    [Migration("20240701163335_AddPLLocal")]
    partial class AddPLLocal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LABAPP.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LABAPP.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LABAPP.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LABAPP.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LABAPP.Authorization.Roles.Role", b =>
                {
                    b.HasOne("LABAPP.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("LABAPP.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("LABAPP.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
